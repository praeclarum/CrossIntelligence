...
class ResponsesApiSessionImplementation : IIntelligenceSessionImplementation
{
    ...
    public ResponsesApiSessionImplementation(string baseUrl, string model, string apiKey, IIntelligenceTool[]? tools, string instructions, HttpClient? httpClient = null)
    {
    ...
    ~ResponsesApiSessionImplementation()
    {
        Dispose(false);
    }
